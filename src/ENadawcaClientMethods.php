...
trait ENadawcaClientMethods 
{
    ...
    public function getLibrariesForLegalDeposits(Type\GetLibrariesForLegalDeposits $request) : Type\GetLibrariesForLegalDepositsResponse
    {
        return $this->callMethod('getLibrariesForLegalDeposits', $request);
    }

    public function orderEasyReturnSolutionLabel(Type\OrderEasyReturnSolutionLabel $request) : Type\OrderEasyReturnSolutionLabelResponse
    {
        return $this->callMethod('orderEasyReturnSolutionLabel', $request);
    }

    public function getPlacowkaPocztowa(Type\GetPlacowkaPocztowa $request) : Type\GetPlacowkaPocztowaResponse
    {
        return $this->callMethod('getPlacowkaPocztowa', $request);
    }

    public function getParcelContentList(Type\GetParcelContentList $request) : Type\GetParcelContentListResponse
    {
        return $this->callMethod('getParcelContentList', $request);
    }

    public function createParcelContent(Type\CreateParcelContent $request) : Type\CreateParcelContentResponse
    {
        return $this->callMethod('createParcelContent', $request);
    }

    public function updateParcelContent(Type\UpdateParcelContent $request) : Type\UpdateParcelContentResponse
    {
        return $this->callMethod('updateParcelContent', $request);
    }

    public function deleteParcelContent(Type\DeleteParcelContent $request) : Type\DeleteParcelContentResponse
    {
        return $this->callMethod('deleteParcelContent', $request);
    }

    public function createReturnDocumentsProfile(Type\CreateReturnDocumentsProfile $request) : Type\CreateReturnDocumentsProfileResponse
    {
        return $this->callMethod('createReturnDocumentsProfile', $request);
    }

    public function updateReturnDocumentsProfile(Type\UpdateReturnDocumentsProfile $request) : Type\UpdateReturnDocumentsProfileResponse
    {
        return $this->callMethod('updateReturnDocumentsProfile', $request);
    }

    public function deleteReturnDocumentsProfile(Type\DeleteReturnDocumentsProfile $request) : Type\DeleteReturnDocumentsProfileResponse
    {
        return $this->callMethod('deleteReturnDocumentsProfile', $request);
    }

    public function getReturnDocumentsProfileList(Type\GetReturnDocumentsProfileList $request) : Type\GetReturnDocumentsProfileListResponse
    {
        return $this->callMethod('getReturnDocumentsProfileList', $request);
    }

    public function createChecklistTemplate(Type\CreateChecklistTemplate $request) : Type\CreateChecklistTemplateResponse
    {
        return $this->callMethod('createChecklistTemplate', $request);
    }

    public function updateChecklistTemplate(Type\UpdateChecklistTemplate $request) : Type\UpdateChecklistTemplateResponse
    {
        return $this->callMethod('updateChecklistTemplate', $request);
    }

    public function deleteChecklistTemplate(Type\DeleteChecklistTemplate $request) : Type\DeleteChecklistTemplateResponse
    {
        return $this->callMethod('deleteChecklistTemplate', $request);
    }

    public function getChecklistTemplateList(Type\GetChecklistTemplateList $request) : Type\GetChecklistTemplateListResponse
    {
        return $this->callMethod('getChecklistTemplateList', $request);
    }

    public function getAdditionalActivitiesList(Type\GetAdditionalActivitiesList $request) : Type\GetAdditionalActivitiesListResponse
    {
        return $this->callMethod('getAdditionalActivitiesList', $request);
    }
