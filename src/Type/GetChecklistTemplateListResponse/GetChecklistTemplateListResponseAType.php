...
namespace Abryb\ENadawca\Type\GetChecklistTemplateListResponse;

/**
 * Class representing GetChecklistTemplateListResponseAType
 */
class GetChecklistTemplateListResponseAType
{
    /**
