...
namespace Abryb\ENadawca\Type\DeleteReturnDocumentsProfileResponse;

/**
 * Class representing DeleteReturnDocumentsProfileResponseAType
 */
class DeleteReturnDocumentsProfileResponseAType
{
    /**
     * @var bool $result
     */
