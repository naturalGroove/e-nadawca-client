...
namespace Abryb\ENadawca\Type\CreateReturnDocumentsProfileResponse;

/**
 * Class representing CreateReturnDocumentsProfileResponseAType
 */
class CreateReturnDocumentsProfileResponseAType
{
    /**
     * @var bool $result
     */
