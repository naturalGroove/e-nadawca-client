...
namespace Abryb\ENadawca\Type\DeleteChecklistTemplateResponse;

/**
 * Class representing DeleteChecklistTemplateResponseAType
 */
class DeleteChecklistTemplateResponseAType
{
    /**
